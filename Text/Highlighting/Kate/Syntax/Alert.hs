{- This module was generated from data in the Kate syntax highlighting file alert.xml, version 1.07,
   by  Dominik Haumann (dhdev@gmx.de) -}

module Text.Highlighting.Kate.Syntax.Alert ( highlight, parseExpression, syntaxName, syntaxExtensions ) where
...
parseExpression = do
  ...
  setState $ st { synStLanguage = "Alerts" }
...
styles = [("Normal Text","Normal"),("Alert","Alert")]
